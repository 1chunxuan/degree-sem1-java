...
public class RecursiveDisplayArray {
  ...
  private static void displayArrayBackwards(Object[] array,int first,int last){
      if(first<=last){
          System.out.println(array[last]+" ");
      displayArrayBackwards(array,first,last-1);
      }
          
  }
  
  public static void displayArrayBackwards(Object[] array){
      displayArrayBackwards(array,0,array.length-1);
      System.out.println("\n\n\n\n");
  ...
  public static void main(String[] args) {
    Integer[] intArray = {10, 20, 30, 40, 50, 60};
      System.out.println("\nintArray in reverse:");
      displayArrayBackwards(intArray);
