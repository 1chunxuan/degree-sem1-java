...
public class PostOfficeSim extends javax.swing.JFrame {
    ...
    private class CounterListener implements ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {
            if (q.isEmpty()) {
                JOptionPane.showMessageDialog(null, "no Customer waiting to be served", "Empty queue", JOptionPane.INFORMATION_MESSAGE);
            } else {
                String buttonStr = e.getActionCommand();
                System.out.println(buttonStr);
                int counterNum = Integer.parseInt(buttonStr.substring(counterNoIndex));
//            System.out.println(buttonStr+"-->"+counterNum);
                Customer customer = q.poll();//remove customer from the front of queue
                customer.setCounter(counterNum);
    ...
    private void jbtReportActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtReportActionPerformed
        ...
        for(int i=0;i<serviceList.size();i++){
            ...
            str+=String.format("%-8s %-82s %7d \n"
                    ,(i+1)+".",c,waitingTime);
            str+="\nTotal customers served :"+serviceList.size();
            str+=String.format("\nAverage waiting time: %.2f\n",totalTime/serviceList.size());//can put (double)in front of totalTime
        }
